...
/** @lends DomPanel */
{
  ...
  icon: "./icon-16.png",
  //url: "./dom.html",
  url: "chrome://firebug/content/dom.xhtml",
  ...
  open: function(window, toolbox) {
    ...
    let iframe = parentDoc.getElementById("toolbox-panel-iframe-domPanel");
    ...
    let win, doc;
    if ((win = iframe.contentWindow) && (doc = win.document) &&
    ...
    toolbox.once("domPanel-ready", (event, panel) => {
...
gDevTools.registerTool({
  ...
  url: "chrome://firebug/content/dom.xhtml",
  label: Locale.$STR("domPanelTitle"),
  tooltip: Locale.$STR("domPanelTooltip"),
